...
private:
    ...
    ShaderProgram m_progBlinnPhong;// A shader program that uses lambertian reflection

    ShaderProgram m_progPostProcessNoOp;
    ShaderProgram m_progPostProcessUnderWater;
    ShaderProgram m_progPostProcessUnderLava;

    ShaderProgram *m_selectedPostProcessShader;
    ...
    Texture m_texture;
    Texture m_underwater;
    Texture m_underlava;

    QSoundEffect m_grassWalk;
    QSoundEffect m_stoneWalk;
    QSoundEffect m_snowWalk;
    QSoundEffect m_swim;
    QSoundEffect m_splash;
    QSoundEffect m_ariaMath;

    bool jumpedIntoWater = true;
public:
    explicit MyGL(QWidget *parent = nullptr);
    ~MyGL();

    // This method starts the timer.
    // This way, the game doesn't immediately launch upon startup.
    void startGame();
    // Similarly, this method stops the timer.
    void stopGame();
    ...
    void setFolderLocation(std::string folderLocation);
    void triggerSave();
